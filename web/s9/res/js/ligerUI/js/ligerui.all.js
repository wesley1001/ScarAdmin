...
(function ($)
{
    ...
    {
        var target = $('<textarea class="l-dialog-textarea"></textarea>');
...
(function ($)
{
    ...
    $.ligerui.controls.Grid.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _render: function ()
        {
            ...
            gridhtmlarr.push("        <div class='l-panel-topbar'><div class='l-panel-topbarinner'></div></div><div class='l-clear'></div>");
