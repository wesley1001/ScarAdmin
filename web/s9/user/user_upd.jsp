...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=basePath %>/s9/user/js/usermap.js"></script>
		<style type="text/css">
			body, html,#allmap {width: 100%;height: 100%;overflow: hidden;position:absolute;z-index:999999;margin:0;font-family:"微软雅黑";}
		</style>
			      ...
			      <table width="100%" border="0" cellpadding="0" cellspacing="0">
			      	<tbody><tr>
						...
						<tr>
							...
							<td>
								<input type="text" id="organId" name="organId" value="${user.organId}" />
							</td>
						</tr>
						<tr>
							<td height="30" align="right">
						...
						<tr>
							...
							<td>
								<input type="text" id="expHintDate" name="expHintDate" value="${user.expHintDate}" />
