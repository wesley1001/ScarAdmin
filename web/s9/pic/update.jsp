...
<body class="dialogBody">
		<form id="editeForm" action="" method="post" onsubmit="return false;">
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								<tbody>
									...
									<tr>
										...
										<td>
											<input type="text" id="url" name="url" value="${bo.url}">
											<span
												style="color: red; padding-left: 2px; padding-top: 13px;">*</span>
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<input type="text" id="attachmentUrl" name="attachmentUrl" value="${bo.attachmentUrl}" />
									...
									<tr style="">
										...
										<td>
											<input  type="text" id="tum" name="tum" value="${bo.tum}">
										</td>
									</tr>
									<tr style="">
										<td height="30" align="right">
