			...
			<td width="400">
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td width="80%" >
							<input type="text" id="startTime" name="startTime" readonly="readonly" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true})" class="Wdate"
					...
					<tr>
						...
						<td width="80%" >
							<input type="text" id="endTime" name="endTime" readonly="readonly" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true})" class="Wdate"
