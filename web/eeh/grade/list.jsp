...
<html>
	<head>
		...
		<!-- 用户管理操作JS静态资源的引用 -->
			...
			<script type="text/javascript" src="<%=basePath%>/eeh/grade/js/list.js?v=4"></script>
	...
	<body class="z-body-detail" style="overflow: hidden">
								...
								<div class="z-toolbar-overflow"> 
									<div class="z-toolbar-nowrap">
										<a href="javascript:void(0);" class="z-btn z-btn-flat" onclick="add();">
											<img class="icon021a4" src="../s9/res/img/icon000.png"><b>添加班级<i></i></b>
										</a>
		...
		<script type="text/javascript">
			// 初始化加载
			$(function(){
				var url='../grade/findAllList.shtml';
				findAllList(url);
			})
